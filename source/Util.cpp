...
string get_manual() {
    string s = "__________________________________________________________________________________________________________________________\n"
        ...
        + "--------------------------------------------------------------------------------------------------------------------------\n"
        + "Command\t\tOptions/Flags" + "\tUsage\t\t\tDescription\n\n"
        ...
        + "cd" + "\t\t" + "\t\tcd [dest]" + "\t\tChange current directory.\n"
        + "rm" + "\t\t-r" + "\t\trm [options] [name]" + "\tRemove File/folder from current directory.\n\t\t\t\t\t\t\tUse \'-r\' to delete recursively.\n"
        ...
        + "open" + "\t\t-r -w" + "\t\topen [mode] [file_name]" + "\tOpen file to read/write.\n"
